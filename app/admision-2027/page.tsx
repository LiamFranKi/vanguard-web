...
export const metadata: Metadata = {
  title: 'Admisión 2027 - Vanguard Schools',
  description:
    'Formulario de admisión y ratificación para el año 2027 en Vanguard Schools. Regístrate y nos comunicaremos contigo.',
}
