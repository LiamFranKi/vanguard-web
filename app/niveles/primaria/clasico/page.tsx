...
import { FiBook, FiUsers, FiCpu, FiAward, FiHome, FiDroplet, FiGrid, FiBookOpen, FiUsers as FiUsersIcon, FiSmartphone, FiDatabase, FiMusic, FiCoffee, FiFilm, FiTablet, FiGlobe } from 'react-icons/fi'
import NivelInversion from '@/components/niveles/NivelInversion'
import NivelClasicoAviso from '@/components/niveles/NivelClasicoAviso'
...
export const metadata: Metadata = {
  title: 'Educación Primaria (diseño anterior) - Vanguard Schools',
  description: 'Versión anterior de Educación Primaria en Vanguard Schools.',
...
export default async function PrimariaPage() {
  ...
  return (
    <div className="pt-20">
      <NivelClasicoAviso hrefNuevo="/niveles/primaria" />
      {/* Hero Section */}
