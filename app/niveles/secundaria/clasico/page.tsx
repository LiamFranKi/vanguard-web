...
export const metadata: Metadata = {
  title: 'Educación Secundaria (diseño anterior) - Vanguard Schools',
  description: 'Versión anterior de Educación Secundaria en Vanguard Schools.',
...
export default async function SecundariaPage() {
  ...
  return (
    <div className="pt-20">
      <NivelClasicoAviso hrefNuevo="/niveles/secundaria" />
      {/* Hero Section */}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <NivelInversion
              titulo="Inversión del Nivel Secundaria en Vanguard Schools"
              grupos={[
                { etiqueta: '1° de Secundaria' },
                { etiqueta: '2° a 5° de Secundaria' },
              ]}
